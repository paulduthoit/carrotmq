 ...
 * @api public
 *
 * @alternative HareMQ.createReplyQueue = function() { ... };
 * @alternative HareMQ.createReplyQueue = function(queueName) { ... };
 * @alternative HareMQ.createReplyQueue = function(options) { ... };
 * @alternative HareMQ.createReplyQueue = function(queueName, options) { ... };
 */
